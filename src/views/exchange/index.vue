<template>
  <section>
    ...
    <dl class="clearfix">
     ...
     <ul class="theList">
        <li class="clearfix">
            <span class="fl">换货原因</span>
            <font class="fr rightNow"></font>
        </li>
        <li class="clearfix">
            <span class="fl">换货说明</span>
            <input class="fr" placeholder="请在此处添加说明,可不填">
        </li>
     </ul>
    <div class="uploadImg">
        <h5>上传凭证</h5>
        <div class="clearfix">
            <ul class="clearfix fl">
                <li class="fl" v-for="(item,index) in imgData" :key="index"></li>
            </ul>
